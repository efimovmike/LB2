...
Store::Store()
{
    ...
    cout << "Vizvan konstructor po umolchaniyu classa Store" << endl;
}
...
Store::Store(int size)
{
    ...
    this->countElement = 0; // кол-во элементов = 0
    cout << "Vizvan lonstructor s parametrom classa Store" << endl;
}
...
Store::Store(const Store &s)
{
    ...
    cout << "Vizvan konstructor kopirovaniya classa Store" << endl;
}
...
Store::~Store()
{
    ...
    cout << "Vizvan destructor classsa Store" << endl;
}
...
void Store::FindTrain()
{
    ...
    if (!flagFind) cout << "\nPoezdov po takomu marshrutu net" << endl; // если поездов по такому пункту нет
}
...
void Store::GetFiel()
{
    ...
    cout << "\nVvedite nomer elementa polya kotorogo you hotite vivesty: ";
    cin >> choice; // ввод
...
void Store::Change()
{
    ...
    cout << "\nViberete nomer elementa dannie kotorogo hotite izmenit: ";
...
void Store::Delete()
{
    ...
    cout << "\nViberete nomer elementa dannie kotorogo hotite udalit: ";
